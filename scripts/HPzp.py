...
# If True, a new model 'checkpoint_best_robust.pth' will be created and evaluated.
...
# --- NEW: Adversarial Fine-Tuning Function ---
...
# --- NEW: Refactored Attack Evaluation Function ---
def run_attack_evaluation(patient_id, slice_idx, attack_config, models_dict, device, output_base_dir,
    ...
    gradient_model = models_dict.get(attack_config['grad_model_name']) # Use .get for noise case
    ...
    try:
        ...
        # --- NEW: Save Visualizations (with Gradient Heatmap) ---
        ...
        # Panel 2: NEW - Gradient Map Heatmap
...
if __name__ == "__main__":
    ...
    patient_cases_for_attack = [f"BraTS2021_{i:05d}" for i in range(5, 15)] # 10 patients for attack demo
    ...
    if not df_successful.empty:
        ...
        # 2. NEW: Paired Statistical Tests
