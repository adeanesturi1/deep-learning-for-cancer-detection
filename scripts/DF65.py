...
def run_attack_and_save_results(patient_id, slice_idx, epsilon, model, device, output_base_dir,
    ...
    try:
        ...
        # Check if the NIfTI has already been saved for this patient and epsilon
        # This prevents redundant saving if processing multiple slices for the same patient/epsilon
