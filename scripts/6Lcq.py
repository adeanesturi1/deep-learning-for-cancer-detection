...
# ---------------------------------------------------------------------
#  Main training loop with TensorBoard, mixed precision, optimizations
# ---------------------------------------------------------------------
if __name__ == "__main__":
    ...
    print(f">>> Will train for {args.epochs} epochs", flush=True)(logdir)
    ...
    # Data loaders with caching, parallelism, pin_memory
    ...
    # optimizer & scheduler on decoder + heads initially
