...
def run_attack_and_save_results(patient_id, slice_idx, epsilon, model, device, output_base_dir,
    ...
    try:
        ...
        fig, axs = plt.subplots(1, 3, figsize=(18, 6)) # Wider figure for 3 panels

        # Get standard deviation for modality 1 (T1ce) for denormalizing perturbation
        # This is needed for visualizing perturbation in a meaningful scale
        ...
        # Plot 2: Perturbation
        # Calculate perturbation: adv_image_tensor - img_tensor_normalized
